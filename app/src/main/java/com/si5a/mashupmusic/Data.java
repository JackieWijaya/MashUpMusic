...
public class Data {
    ...
    public static  String[][] data = new String[][] {
            {"SING-OFF TIKTOK SONGS Part II (You Broke Me First, De Yang Gatal Gatal Sa) vs Mirriam Eka","Video ini adalah konten ber-copyright. sebagian penghasilan dari youtube akan masuk ke artist original pemilik lagu. Jika kalian mau memberikan support lebih berupa donasi pada kami untuk membantu memajukan channel ini, bisa klik link dibawah ini ya! Terima kasih banyak | https://saweria.co/rezadarmawangsa\n","X3wYCb2tACk"},
